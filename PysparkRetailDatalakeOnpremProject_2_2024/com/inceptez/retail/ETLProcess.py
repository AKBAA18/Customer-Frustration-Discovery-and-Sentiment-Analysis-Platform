...
def writeHiveTableSCD2(tableexistflag,sparksess,hive_table,df_employees_new_updated):
    if tableexistflag:
        ...
        location 'hdfs:///user/hduser/empdata/'""")
...
def writeHiveTableDeltaMerge(tableexistflag,sparksess,hive_table,df_products_new):
    if tableexistflag:
        ...
        df_hive_existing.write.format("delta").mode('overwrite').save("hdfs:///user/hduser/df_hive_existing")
        exist_df = DeltaTable.forPath(sparksess, "hdfs:///user/hduser/df_hive_existing")

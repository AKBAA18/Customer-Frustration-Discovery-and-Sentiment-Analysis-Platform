...
#import shutil
#shutil.make_archive("/home/hduser/PysparkRetailDatalakeOnpremProject_2_2024/common_functions1","zip", root_dir="/home/hduser/PycharmProjects/RetailProject/")
...
def main(arg1_conn_file,arg2_conn_jar,arg3_spark_sess):
    #arg2_conn_jar -> jdbc_lib
    #arg3_spark_sess -> propfile
    ...
    df_cust_navigation=read_data("json",spark,"file:///home/hduser/PysparkRetailDatalakeOnpremProject_2_2024/cust_navigation.json",strtype)
    ...
    row format delimited fields terminated by ','
    location 'hdfs:///user/hduser/dimorders/'""")

    spark.sql("""load data local inpath 'file:///home/hduser/PysparkRetailDatalakeOnpremProject_2_2024/orders_rate.csv' 
    ...
    spark.sql("""create external table if not exists retail_discovery.cust_frustration_level 
      ...
      row format delimited fields terminated by ',' 
      location 'hdfs:///user/hduser/custmartfrustration/'""")
